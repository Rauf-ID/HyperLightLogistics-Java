...
public class DeliveryOption {
    ...
    @Id
    @SequenceGenerator(name = "delivery_options_seq", sequenceName = "delivery_options_sequence", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "delivery_options_seq")
    private Long id;
